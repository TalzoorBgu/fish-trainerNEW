...
proc vTclWindow.top37 {base} {
    ...
    wm geometry $top 891x800+281+53
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    button $site_3_0.but39 \
        ...
        -background {#d9d9d9} -command onRunTraining -foreground {#000000} \
    ...
    text $site_3_0.tex79 \
        ...
        -selectforeground black -undo 1 -width 218 -wrap word 
    .top37.fra38.tex79 configure -font TkTextFont
    ...
    button $site_3_0.but38 \
        -activebackground {#d9d9d9} -activeforeground {#000000} \
        -background {#d9d9d9} -command onStopTraining -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -text {Stop traning} 
    ...
    text $site_3_0.tex45 \
        ...
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -insertbackground black -selectbackground {#c4c4c4} \
        -selectforeground black -undo 1 -width 90 -wrap word 
    ...
    text $site_3_0.tex46 \
        ...
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -insertbackground black -selectbackground {#c4c4c4} \
        -selectforeground black -undo 1 -width 82 -wrap word 
    ...
    place $site_3_0.but38 \
        -in $site_3_0 -x 768 -y 56 -width 87 -relwidth 0 -height 62 \
        -relheight 0 -anchor nw -bordermode ignore 
    ...
    button $site_3_0.but55 \
        -activebackground {#d9d9d9} -activeforeground {#000000} \
        -background {#d9d9d9} -command onStatClear -foreground {#000000} \
    ...
    button $site_3_0.but56 \
        -activebackground {#d9d9d9} -activeforeground {#000000} \
        -background {#d9d9d9} -command onStatRun -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black -text Run 
    ...
    text $site_3_0.tex42 \
        ...
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -insertbackground black -selectbackground {#c4c4c4} \
        -selectforeground black -undo 1 -width 74 -wrap word 
    ...
    label $site_3_0.lab43 \
        -activebackground {#f9f9f9} -activeforeground black \
        -background {#d9d9d9} -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black -text {Run arg.} 
    vTcl:DefineAlias "$site_3_0.lab43" "Label13" vTcl:WidgetProc "MainGUI" 1
    text $site_3_0.tex44 \
        -background white -font font9 -foreground black \
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -insertbackground black -selectbackground {#c4c4c4} \
        -selectforeground black -undo 1 -width 378 -wrap word 
    ...
    text $site_3_0.tex46 \
        ...
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -insertbackground black -selectbackground {#c4c4c4} \
        -selectforeground black -undo 1 -width 442 -wrap word 
    ...
    button $site_3_0.but61 \
        -activebackground {#d9d9d9} -activeforeground {#000000} \
        -background {#d9d9d9} -command onSendtest -foreground {#000000} \
    ...
    button $site_3_0.but38 \
        -activebackground {#d9d9d9} -activeforeground {#000000} \
        -background {#d9d9d9} -command onTankConfig -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -text {Tank conf.} 
    ...
    place $site_3_0.lab62 \
        -in $site_3_0 -x 552 -y 8 -anchor nw -bordermode ignore 
    place $site_3_0.but65 \
        -in $site_3_0 -x 672 -y 8 -width 87 -relwidth 0 -height 38 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but66 \
        -in $site_3_0 -x 672 -y 48 -width 87 -relwidth 0 -height 38 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but67 \
        -in $site_3_0 -x 760 -y 48 -width 87 -relwidth 0 -height 38 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but68 \
        -in $site_3_0 -x 760 -y 8 -width 87 -relwidth 0 -height 38 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab69 \
        -in $site_3_0 -x 560 -y 32 -anchor nw -bordermode ignore 
    place $site_3_0.ent70 \
        -in $site_3_0 -x 576 -y 56 -width 80 -relwidth 0 -height 27 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but38 \
    ...
    button $site_3_0.but38 \
        -activebackground {#d9d9d9} -activeforeground {#000000} \
        -background {#d9d9d9} -command onLogClear -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black -text Clear 
    ...
    ###################
    place $top.fra38 \
        -in $top -x 8 -y 376 -width 864 -relwidth 0 -height 131 -relheight 0 \
    ...
    place $top.fra52 \
        ...
        -anchor nw -bordermode ignore 
    place $top.fra57 \
        -in $top -x 16 -y 280 -width 864 -relwidth 0 -height 91 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.fra71 \
        -in $top -x 16 -y 512 -width 861 -relwidth 0 -height 235 -relheight 0 \
        -anchor nw -bordermode ignore 
