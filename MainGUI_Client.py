...
class Fish_traning_GUI___Client:
    def __init__(self, top = None):
        ...
        self.radCam1.configure(command=ClientGUI_support.R_Cam1Sel)
        ...
        self.radCam2.configure(command=ClientGUI_support.R_Cam1Sel)
        ...
        self.btnTankConf.configure(width=73)
